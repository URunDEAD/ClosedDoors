...
func TestCheckExpiredKey(t *testing.T) {
	...
	var addTests = []addTest{
		...
		{"76ba2389a80bb0ee15d8107f676ea464d777647ed810051dfae38d9abd7350ee", false},
		{"ecbe9eb7cec2f0d826cb1dba9d0f7a1a691a898a4ccce4d87d604d09094a3150", false},
	}

	expire_time := time.Now().Add(-time.Hour * 10).Format("2006-01-02 15:04:05")
